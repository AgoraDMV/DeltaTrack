"""Integrity gate for the frozen #524 candidate 4 (conservative).
...
`FROZEN4.sha256` records the digest of `frozen_candidate4.py` at freeze time. This
...
SPEC = HERE / "frozen_candidate4.py"
DIGEST_FILE = HERE / "FROZEN4.sha256"
