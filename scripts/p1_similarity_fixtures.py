...
FIXTURES = [
    ...
    },
    {
        ...
        "b": to_curly_quotes('The Secretary shall "certify" that the contractor is eligible and that \'all\' requirements are met.'),
...
def main() -> None:
    ...
    # Write CSV
    fieldnames = ["label", "a_len", "b_len", "ratio", "classification",
                  "expected_concern", "flag", "a_preview", "b_preview"]
